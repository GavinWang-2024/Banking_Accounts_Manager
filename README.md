<div align="center">
  <h3 align="center">A Fintech Bank Accounts Manager</h3>
...
👉 The application features ultra-secure SSR authentication with robust validations and authorization, integrates Plaid for linking multiple bank accounts, and displays a home page overview with total balances, recent transactions, and spending categories. Users can view a complete list of connected banks and balances under "My Banks" and access paginated, filterable transaction history. Real-time updates reflect changes across pages when new accounts are connected. Funds transfer is supported via Dwolla with required recipient details. The design ensures responsiveness across desktop, tablet, and mobile devices for a seamless user experience.
...
```bash
git clone https://github.com/GavinWang-2024/banking_account_manager.git
```
...
Replace the placeholder values with your actual respective account credentials, obtained by signing up on the [Appwrite](https://appwrite.io/?utm_source=youtube&utm_content=reactnative&ref=JSmastery), [Plaid](https://plaid.com/) and [Dwolla](https://www.dwolla.com/)
